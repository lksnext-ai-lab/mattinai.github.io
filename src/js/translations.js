  ...
  es: {
    ...
    features: {
      ...
      rag: {
        ...
        description: "Potentes sistemas de Generación Aumentada por Recuperación (RAG) con capacidades de búsqueda semántica y gestión de bases de datos vectoriales usando PostgreSQL + pgvector/Qdrant."
      },
      agents: {
        title: "Agentes de IA y Automatización",
        description: "Construye agentes de IA inteligentes con nuestro marco de automatización integral. Crea arquitecturas sofisticadas de múltiples agentes y automatización de tareas."
      },
      modular: {
        title: "Arquitectura Modular",
        description: "Diseño extensible y modular con backend FastAPI/Python y frontend React/TypeScript. Fácil de personalizar y extender según tus necesidades."
      },
      technical: {
    ...
    architecture: {
      ...
      subtitle: "Arquitectura técnica de los agentes MattinAI, diseñada para flexibilidad, escalabilidad y observabilidad.",
      configuration: {
        title: "Configuración",
  ...
  en: {
    ...
    features: {
      ...
      rag: {
        ...
        description: "Powerful Retrieval-Augmented Generation (RAG) systems with semantic search capabilities and vector database management using PostgreSQL + pgvector/Qdrant."
      },
      agents: {
        title: "AI Agents & Automation",
        description: "Build intelligent AI agents with our comprehensive automation framework. Create sophisticated multi-agent architectures and task automation."
      },
      modular: {
        title: "Modular Architecture",
        description: "Extensible and modular design with FastAPI/Python backend and React/TypeScript frontend. Easy to customize and extend for your needs."
      },
      technical: {
    ...
    architecture: {
      ...
      subtitle: "Technical architecture of MattinAI agents, designed for flexibility, scalability, and observability.",
      configuration: {
        title: "Configuration",
  ...
  eu: {
    ...
    features: {
      ...
      rag: {
        ...
        description: "Berreskuratze Gehigarrizko Sorkuntza (RAG) sistema ahaltsuak bilaketa semantiko gaitasunekin eta bektore datu-baseen kudeaketarekin PostgreSQL + pgvector/Qdrant erabiliz."
      },
      agents: {
        title: "AI Agenteak eta Automatizazioa",
        description: "Eraiki AI agente adimentsuak gure automatizazio esparru integralarekin. Sortu agente anitzeko arkitektura sofistikatuak eta zeregin automatizazioa."
      },
      modular: {
        title: "Arkitektura Modularra",
        description: "Diseinu hedagarri eta modularra FastAPI/Python backend eta React/TypeScript frontend-ekin. Erraza pertsonalizatzeko eta zure beharretarako hedatzeko."
      },
      technical: {
        title: "Eskakizun Teknikoak",
        backend: "Backend",
        frontend: "Frontend",
        database: "Datu-basea",
        framework: "Framework",
    ...
    architecture: {
      ...
      subtitle: "MattinAI agenteen arkitektura teknikoa, malgutasuna, eskalagarritasuna eta behaketa kontuan hartuta diseinatua.",
      configuration: {
        title: "Konfigurazioa",
